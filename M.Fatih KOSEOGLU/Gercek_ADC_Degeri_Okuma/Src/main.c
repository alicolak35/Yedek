...
//v_ref'te yanlılık olabilir
uint16_t adc_value[2];//2 elemanlı olduğunu belirtiyo, indeks 0 ve 1: bu yargı doğru mu?
float Vadc , Vdda;
int count = 0;
...
void ADC_Okuma() {
	  ...
	  if(HAL_ADC_PollForConversion(&hadc1, 168000) == HAL_OK){
